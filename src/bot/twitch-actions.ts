// src/bot/twitch-actions.ts
/**
 * This file contains pure, backend-only functions for interacting with the Twitch API.
 * It has no dependencies on Next.js or React and can be safely used by the bot.
 */
